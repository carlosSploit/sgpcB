...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-10-2022 a las 16:15:34
...
SELECT cc.id_ciclo_curso ,ips.id_inscrip, us.nombre, us.photo, SUM(pc.value_point) as sumatotal
...
INNER JOIN sesiones s ON s.id_sesion = ips.id_sesion 
INNER JOIN ciclo_curso cc ON cc.id_ciclo_curso = s.id_ciclocurso 
AND cc.id_ciclo_curso = id_ciclocurso 
AND ips.stade <> 0 
GROUP BY ips.id_inscrip 
...
INSERT INTO `puntosclass` (`id_tipo_puntos`, `nombre`, `value_point`, `photo`, `id_profesor`, `stade`, `isacumulado`, `isdefault`) VALUES
...
--
ALTER TABLE `conte_tarea`
  MODIFY `id_conte_tarea` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `inscripcciones`
  MODIFY `id_inscrip` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;

--
-- AUTO_INCREMENT de la tabla `inscrip_point_sesion`
--
ALTER TABLE `inscrip_point_sesion`
  MODIFY `id_inscrip_p_sea` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `puntosclass`
  MODIFY `id_tipo_puntos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `sing_log`
  MODIFY `id_sing_log` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=133;

--
-- AUTO_INCREMENT de la tabla `tarea_conte_inscr`
--
ALTER TABLE `tarea_conte_inscr`
  MODIFY `id_tarea_inscri` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
