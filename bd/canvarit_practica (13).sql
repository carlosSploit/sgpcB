...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-09-2022 a las 21:35:44
...
(51, 'P', 'canvaritech.gerente@gmail.com', 'Universidad Pri', 'ANCAJIMA MAURIOLA Julio Sergio Adolfo', 978376948, 'canvaritech.gerente@gmail.com', 1, 'https://thumbs.dreamstime.com/b/icono-gris-de-perfil-usuario-s%C3%ADmbolo-empleado-avatar-web-y-dise%C3%B1o-ilustraci%C3%B3n-signo-aislado-en-fondo-blanco-191067342.jpg'),
...
--
ALTER TABLE `puntosclass`
  MODIFY `id_tipo_puntos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `sing_log`
  MODIFY `id_sing_log` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=125;
