...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-11-2022 a las 03:38:52
...
(28, 13, 'Carlos Alberto Guerrero Garcia.', 985796307, 69, 6),
...
(65, 'C', 'caro@gmail.com', '123456', 'carolina', 985796307, 'caro@gmail.com', 1, 'https://thumbs.dreamstime.com/b/icono-gris-de-perfil-usuario-s%C3%ADmbolo-empleado-avatar-web-y-dise%C3%B1o-ilustraci%C3%B3n-signo-aislado-en-fondo-blanco-191067342.jpg'),
...
(69, 'C', 'artu222000@gmail.com', '123456', 'Carlos Arturo Guerrero Garcia', 985796307, 'artu222000@gmail.com', 1, 'https://thumbs.dreamstime.com/b/icono-gris-de-perfil-usuario-s%C3%ADmbolo-empleado-avatar-web-y-dise%C3%B1o-ilustraci%C3%B3n-signo-aislado-en-fondo-blanco-191067342.jpg'),
(70, 'C', 'alexgar@gmail.com', '123456', 'Alexander Garcia', 985796307, 'alexgar@gmail.com', 1, 'http://res.cloudinary.com/canvarith/image/upload/v1667439808/Images/dzd7tbr6mdj8aoynhcpg.jpg');
...
--
ALTER TABLE `inscripcciones`
  MODIFY `id_inscrip` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;

--
-- AUTO_INCREMENT de la tabla `inscrip_point_sesion`
--
ALTER TABLE `inscrip_point_sesion`
  MODIFY `id_inscrip_p_sea` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
ALTER TABLE `sesiones`
  MODIFY `id_sesion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;

--
-- AUTO_INCREMENT de la tabla `sing_log`
--
ALTER TABLE `sing_log`
  MODIFY `id_sing_log` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=143;
...
--
ALTER TABLE `tutor_alumno`
  MODIFY `id_tutor_alumno` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
