...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-04-2023 a las 11:13:54
...
(11, 20, 8, 4, 'Solucionar los problemas por medio de la generaciond e politicas de seguridad.', '', 1),
...
(14, 20, 12, 28, 'jskdjsakld kasjd kasldj askl askdjasl kdjaskld askjd askldj kasd jaskldj askldjaskd askjd askldj ask', '', 1),
...
--
ALTER TABLE `afectaactiv`
  MODIFY `id_afectaActiv` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
...
--
ALTER TABLE `salvafectact`
  MODIFY `id_salvAfectAct` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `valafectamendimen`
  MODIFY `id_valAfectAmenDimen` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `valorafectamen`
  MODIFY `id_valorAfectAmen` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `valoreficacia`
--
ALTER TABLE `valoreficacia`
  MODIFY `id_valorEficacia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
