...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-03-2023 a las 10:09:02
...
(4, 4, 1, 3, 40, 0, 0, 0, 0, 1),
(5, 4, 2, 3, 60, 0, 0, 0, 0, 1),
(6, 4, 3, 3, 50, 0, 0, 0, 0, 1);
...
--
ALTER TABLE `valafectamendimen`
  MODIFY `id_valAfectAmenDimen` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `valoractivdimen`
  MODIFY `id_valorActiDimen` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
