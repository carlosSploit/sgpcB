...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-03-2023 a las 08:43:18
...
SET id_salvAfectAct = (SELECT salvaf.id_salvAfectAct FROM salvafectact salvaf WHERE salvaf.estade = 1 AND salvaf.id_afectaActiv = id_afectaActiv ORDER BY salvaf.id_salvAfectAct LIMIT 1); 
INSERT INTO `valoreficacia`(`id_salvAfectAct`, `id_escalEficDegr`, `valEficDegr`, `id_escalEficFrec`, `valEficFrec`, `estade`, `promValDegradResi`, `promValFrecueResi`, `cuantiValImpactResi`, `cuantiValRiesgoResi`) VALUES (id_salvAfectAct, 0, 0, 0, 0, 1, 0, 0, 0, 0); 
END$$
...
escRiesg.valor as valorCualiRiesg, 
...
INNER JOIN escalariesgo escRiesg ON escRiesg.id_escalRiesgo = valafamdim.id_escalRiesgo 
...
(1, 'Muy Alto', 'MA', 5, '90 - 100', 1),
(2, 'Alto', 'A', 4, '70 - 80', 1),
(3, 'Medio', 'M', 3, '40 - 60', 1),
(4, 'Bajo', 'B', 2, '20 - 30', 1),
(5, 'Despresiable', 'D', 1, '0 - 10', 1);
...
(31, 37, 2000, 6, 3, '2023-03-17 02:01:14', 1),
...
--
ALTER TABLE `recursalvafectact`
  MODIFY `id_recurSalvAfectAct` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `responsalvafectact`
  MODIFY `id_responSalvAfectAct` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `salvafectact`
  MODIFY `id_salvAfectAct` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `valafectamendimen`
  MODIFY `id_valAfectAmenDimen` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `valoractivdimen`
  MODIFY `id_valorActiDimen` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `valoreficacia`
  MODIFY `id_valorEficacia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `valoreficacidimension`
--
ALTER TABLE `valoreficacidimension`
  MODIFY `id_valEficaDimen` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
