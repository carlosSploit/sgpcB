...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-11-2022 a las 14:41:32
...
INSERT INTO `alumno` (`id_alumno`, `edad`, `name_tutor`, `telf_tutor`, `id_usuario`, `id_tutor_alumno`) VALUES
...
INSERT INTO `tutor_alumno` (`id_tutor_alumno`, `nombre_tutAlum`, `id_usuario`) VALUES
...
--
ALTER TABLE `asistencia`
  MODIFY `id_asisten` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `asist_inscrip`
--
ALTER TABLE `asist_inscrip`
  MODIFY `id_asis_inscrip` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `inscripcciones`
  MODIFY `id_inscrip` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
...
--
ALTER TABLE `sing_log`
  MODIFY `id_sing_log` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=167;
