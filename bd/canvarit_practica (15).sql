...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-10-2022 a las 07:59:23
...
SET @id_user = (SELECT ips.id_inscrip_p_sea FROM inscrip_point_sesion ips WHERE ips.id_inscrip = id_inscrip AND ips.id_sesion =  id_sesion AND ips.id_tipo_punto = id_tipopunt ORDER BY ips.id_inscrip_p_sea DESC LIMIT 1);
...
INSERT INTO `admin` (`id_admin`, `tipo_trabajador`, `id_usuario`) VALUES
(15, 'A', 50);
...
INSERT INTO `alumno` (`id_alumno`, `edad`, `name_tutor`, `telf_tutor`, `id_usuario`) VALUES
...
INSERT INTO `asistencia` (`id_asisten`, `fecha_asist`) VALUES
(8, '2022-07-19');
...
INSERT INTO `asist_inscrip` (`id_asis_inscrip`, `id_inscrip`, `id_asisten`, `estado_asistenc`) VALUES
(19, 33, 8, 1);
...
INSERT INTO `ciclo_curso` (`id_ciclo_curso`, `id_curso`, `id_profesor`, `fecha_init`, `fecha_fin`, `presio_inscri`, `dias_durac`, `estado`) VALUES
(25, 14, 18, '2022-07-23', '2022-07-30', '0', 4, 3),
(26, 15, 19, '2022-07-29', '2022-08-20', '51', 6, 3),
(27, 14, 17, '2022-09-30', '2022-10-27', '0', 16, 2),
(28, 14, 17, '2022-10-13', '2022-10-31', '0', 16, 1);
...
INSERT INTO `conte_sesion` (`id_conte_sesion`, `id_sesion`, `id_tipo_conte`, `nombre_conte`, `descripccion`, `url_contenido`, `estado`) VALUES
...
INSERT INTO `conte_tarea` (`id_conte_tarea`, `id_sesion`, `nombre`, `descripc`, `urlconte`, `estado`, `point_max`) VALUES
...
INSERT INTO `correoslp` (`id`, `nombre`, `asunto`, `email`, `mensaje`) VALUES
...
INSERT INTO `correossa` (`id`, `nombre`, `asunto`, `email`, `mensaje`) VALUES
...
INSERT INTO `curso` (`id_curso`, `id_tipo_curso`, `nombre`, `descripccion`, `alcance`, `content_video`, `photoport`, `estado`) VALUES
...
INSERT INTO `inscripcciones` (`id_inscrip`, `id_alumno`, `id_ciclo_curso`, `id_tipo_inscrip`, `url_voucher`, `estado`, `fechainscri`) VALUES
...
INSERT INTO `inscrip_point_sesion` (`id_inscrip_p_sea`, `id_inscrip`, `id_tipo_punto`, `id_sesion`, `fecha_point`, `stade`) VALUES
(1, 33, 8, 31, '2022-09-29 13:26:27', 1),
(2, 33, 10, 31, '2022-09-29 14:02:07', 1),
(3, 33, 8, 32, '2022-09-29 14:03:38', 1),
(4, 33, 8, 31, '2022-09-29 21:45:55', 0),
(5, 33, 10, 31, '2022-09-29 22:22:59', 1);
...
INSERT INTO `profesor` (`id_profesor`, `estudios`, `id_usuario`) VALUES
...
INSERT INTO `puntosclass` (`id_tipo_puntos`, `nombre`, `value_point`, `photo`, `id_profesor`, `stade`) VALUES
(1, 'asistencia', 2, '4', 17, 1),
(2, 'realizo tarrr', 1, '6', 17, 1),
(3, 'no participo', -1, '', 20, 1),
(4, 'participo', 2, '', 20, 1),
(5, 'participo', 1, '', 20, 1),
(6, 'participacion', 1, '3', 17, 1),
(7, 'no participa', -1, '', 17, 0),
(8, 'puntualidad', 1, '', 17, 1),
(9, 'no participo', -1, '2', 17, 1),
(10, 'Puntualidad', 1, '3', 17, 1),
(11, 'Puntualidad', 1, '3', 17, 0),
(12, 'inasistencia', -1, '2', 17, 1),
(13, 'Primero en responder', 2, '8', 17, 0);
...
INSERT INTO `sesiones` (`id_sesion`, `id_ciclocurso`, `nombre`, `estado`) VALUES
...
INSERT INTO `sing_log` (`id_sing_log`, `seccion_key`, `api_key`, `fecha_peticion`, `id_usuario`) VALUES
...
INSERT INTO `tarea_conte_inscr` (`id_tarea_inscri`, `id_inscrip`, `id_conte_tarea`, `urlconte`, `puntos`, `estado`) VALUES
...
INSERT INTO `tipo_conte` (`id_tipo_conte`, `nombre`, `estado`) VALUES
(1, 'Video', 1),
(2, 'Documento', 1),
(3, 'Audio', 1);
...
INSERT INTO `tipo_curso` (`id_tipocurso`, `name`, `estado`) VALUES
(1, 'Todo', 1),
...
INSERT INTO `tipo_inscripcion` (`id_tipo_inscrip`, `nombre`, `estado`) VALUES
(1, 'Inscripción', 1),
(2, 'Pre-inscripción', 1);
...
INSERT INTO `usuario` (`id_usuario`, `tipo_user`, `usser`, `pass`, `nombre`, `telf`, `correo`, `estado`, `photo`) VALUES
...
--
ALTER TABLE `ciclo_curso`
  MODIFY `id_ciclo_curso` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `inscripcciones`
  MODIFY `id_inscrip` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;

--
-- AUTO_INCREMENT de la tabla `inscrip_point_sesion`
--
ALTER TABLE `inscrip_point_sesion`
  MODIFY `id_inscrip_p_sea` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `puntosclass`
  MODIFY `id_tipo_puntos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT de la tabla `sesiones`
--
ALTER TABLE `sesiones`
  MODIFY `id_sesion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;

--
-- AUTO_INCREMENT de la tabla `sing_log`
--
ALTER TABLE `sing_log`
  MODIFY `id_sing_log` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=132;
