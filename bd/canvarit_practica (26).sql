...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-11-2022 a las 20:52:46
...
WHEN @tipo_user = 'A' THEN (SELECT a.id_admin FROM admin a WHERE a.id_usuario = @id_user)
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `read_asisten_info` (IN `id_asisten_inscr` INT)   BEGIN
# LEER LA INFORMACION DE UNA ASISTENCIA
SELECT asis.id_asis_inscrip, asis.id_inscrip, asi.id_asisten, ss.id_sesion, cc.id_ciclo_curso, cc.id_profesor
FROM asist_inscrip asis 
INNER JOIN asistencia asi ON asi.id_asisten = asis.id_asisten 
INNER JOIN sesiones ss ON ss.id_sesion = asi.id_sesion 
INNER JOIN ciclo_curso cc ON cc.id_ciclo_curso = ss.id_ciclocurso 
WHERE asis.id_asis_inscrip = id_asisten_inscr ;
END$$
...
(30, 18, 'desconocido', 969280255, 80, 0),
(31, 13, 'Carlos Alberto Guerrero Garcia.', 985796307, 83, 7),
(32, 13, 'Carlos Garcia Hurtado', 969280255, 85, 7),
(33, 13, 'Carlos Arturo Guerrero Castillo', 969280255, 86, 6);
...
(31, 16, 18, '2022-11-30', '2022-12-30', '20', 5, 1);
...
(16, 16, 'MODELO FODA (Fortalezas, Debilidades, Amenazas y Oportunidades)', 'Este modelo se encarga de poder aprender sobre las amenazas, debilidades, fortalezas, etc.', 'Este curso es un curso genérico que luego será eliminado.', '<div> No se encuentra ningun video </div>', 'http://res.cloudinary.com/canvarith/image/upload/v1668786945/Images/wwhm0j6mymhwlxpqlddk.png', 1);
...
(46, 30, 31, 2, 'http://res.cloudinary.com/canvarith/image/upload/v1668788855/Images/zxlqbcd9nvxdxhadqlml.jpg', 2, '2022-11-18 11:27:35'),
(47, 30, 29, 1, '', 1, '2022-11-18 11:28:05');
...
(39, 41, 36, 44, '2022-11-09 12:17:29', 0),
...
(46, 43, 36, 44, '2022-11-09 21:46:27', 0),
(47, 43, 37, 44, '2022-11-09 21:46:32', 1),
(48, 43, 36, 45, '2022-11-09 21:46:41', 0),
(49, 41, 41, 36, '2022-11-17 14:45:29', 0),
(50, 41, 41, 36, '2022-11-17 14:47:42', 0),
(51, 41, 41, 36, '2022-11-17 14:51:04', 0),
(52, 41, 41, 36, '2022-11-17 14:51:40', 0),
(53, 41, 41, 36, '2022-11-17 14:53:57', 0),
(54, 41, 36, 44, '2022-11-17 16:40:49', 1),
(55, 43, 36, 44, '2022-11-17 16:45:30', 1),
(56, 43, 35, 45, '2022-11-17 16:53:15', 1),
(57, 47, 61, 42, '2022-11-18 14:32:45', 1),
(58, 45, 61, 42, '2022-11-18 14:37:18', 1),
(59, 43, 35, 44, '2022-11-19 13:42:29', 1),
(60, 43, 69, 44, '2022-11-19 13:44:25', 0),
(61, 43, 35, 44, '2022-11-19 13:45:10', 1),
(62, 43, 69, 44, '2022-11-19 13:45:49', 0),
(63, 44, 66, 45, '2022-11-19 13:53:27', 1),
(64, 43, 66, 45, '2022-11-19 23:40:05', 0),
(65, 43, 66, 45, '2022-11-20 00:26:31', 0);
...
(10, 'Puntualidad', 1, '3', 17, 0, 1, 0),
(11, 'Puntualidad', 1, '3', 17, 0, 1, 0),
(12, 'inasistencia', -2, '2', 17, 0, 0, 0),
(13, 'Primero en responder', 2, '8', 17, 0, 1, 0),
(14, 'generico', 1, '7', 17, 0, 1, 0),
(15, 'participacion', 1, '6', 17, 0, 1, 0),
(16, 'No Participo', 1, '2', 17, 0, 1, 0),
(17, 'No Participo', -1, '2', 17, 0, 1, 0),
(18, 'participo', 1, '1', 20, 1, 1, 0),
(19, 'Participación grupal', 1, '5', 17, 0, 0, 0),
(20, 'Asistencia', 1, '6', 17, 0, 0, 0),
(21, 'Asistencia', 1, '6', 17, 0, 1, 0),
...
(36, 'Asistencia', 1, '1', 19, 0, 0, 1),
(37, 'Participacion', 1, '4', 19, 0, 1, 1),
(38, 'Resolvio Tarea', 1, '6', 19, 0, 1, 1),
...
(54, 'Asistencia', 1, '1', 28, 1, 0, 1),
(55, 'Participacion', 1, '4', 28, 1, 1, 1),
(56, 'Resolvio Tarea', 1, '6', 28, 1, 1, 1),
(57, 'Asistencia', 1, '1', 18, 1, 0, 1),
(58, 'Participacion', 1, '4', 18, 1, 1, 1),
(59, 'Resolvio Tarea', 1, '6', 18, 1, 1, 1),
(60, 'Resolvio juego', 1, '4', 18, 1, 1, 0),
(61, 'Asistencia', 1, '1', 17, 1, 0, 1),
(62, 'Participacion', 1, '4', 17, 1, 1, 1),
(63, 'Resolvio Tarea', 1, '6', 17, 1, 1, 1),
(64, 'no participo', -1, '2', 19, 1, 1, 0),
(65, 'no participo', -1, '2', 19, 0, 1, 0),
(66, 'Asistencia', 1, '1', 19, 1, 0, 1),
(67, 'Participacion', 1, '4', 19, 1, 1, 1),
(68, 'Resolvio Tarea', 1, '6', 19, 1, 1, 1),
(69, 'asistenci2', 1, '1', 19, 1, 0, 0);
...
(173, '37956643-df57-4d7f-9bdf-5dd7adaf9338', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjo5NjkyODAyNTUsIm5vbWJyZSI6ImJyYWRjYXIiLCJlbWFpbCI6InVjdjIwMjFAZW1haWwuY29tIn0sImlhdCI6MTY2ODc0NjI3MH0.D9F88pyiwGe6jR_-551kAXjgRk9HRwpOrf1H1n9g3NU', '2022-11-17 23:37:50', 80),
(174, 'd865f4e2-ae05-4d35-955c-dd38aadb2406', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjo5NjkyODAyNTUsIm5vbWJyZSI6ImJyYWRjYXIiLCJlbWFpbCI6InVjdjIwMjFAZW1haWwuY29tIn0sImlhdCI6MTY2ODc4NTAzN30.Ctwr7YpwiAYqQRQx9xMdehHRJcbmzQbbKkyf56uRnQs', '2022-11-18 10:23:57', 50),
(175, 'e5dc968c-72f9-41de-afe7-b6ab3e8dd08d', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjo5NjkyODAyNTUsIm5vbWJyZSI6ImJyYWRjYXIiLCJlbWFpbCI6InVjdjIwMjFAZW1haWwuY29tIn0sImlhdCI6MTY2ODc4NzU1OH0.zTicxpv-xpu-C-W_zRrDtdeWnQsHq72mio4bTEUvgsY', '2022-11-18 11:05:58', 53),
(176, '723de15f-267e-454c-b755-2be28f214286', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjo5NjkyODAyNTUsIm5vbWJyZSI6ImJyYWRjYXIiLCJlbWFpbCI6InVjdjIwMjFAZW1haWwuY29tIn0sImlhdCI6MTY2ODc4ODgxOX0.e89lQ6toirZQ5hl7rKTMZhtKg27ItdmHtiU2h1IOBkw', '2022-11-18 11:26:59', 80),
(177, '34f43c98-3db9-4f4c-ae1e-9b06145a7326', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjo5NjkyODAyNTUsIm5vbWJyZSI6ImJyYWRjYXIiLCJlbWFpbCI6InVjdjIwMjFAZW1haWwuY29tIn0sImlhdCI6MTY2ODc5MDM4N30.XFALhDD6Vi3ugvZk3a2dtZuv8vXgaBBDJB0sBxbaVt0', '2022-11-18 11:53:07', 54),
(178, '29c59f98-4d90-4576-83d5-2d8ac7789d5e', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjo5NjkyODAyNTUsIm5vbWJyZSI6ImJyYWRjYXIiLCJlbWFpbCI6InVjdjIwMjFAZW1haWwuY29tIn0sImlhdCI6MTY2ODc5MDQyM30.h5eIozfbDw0TKz8Y_QzBO_VUHCnn7ZWsgrXAYlLlbnQ', '2022-11-18 11:53:43', 51),
(179, '887a6078-7e58-4519-b6ba-bce0c205b178', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjo5NjkyODAyNTUsIm5vbWJyZSI6ImJyYWRjYXIiLCJlbWFpbCI6InVjdjIwMjFAZW1haWwuY29tIn0sImlhdCI6MTY2ODgwODkwMX0.fP8iEMcd35gkOCaZdUMSTiMsmAAtV76ZzstL1F9ohKw', '2022-11-18 17:01:41', 51),
(180, '3c93ab44-6bcf-41f6-ae0c-8e04ec233652', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjo5NjkyODAyNTUsIm5vbWJyZSI6ImJyYWRjYXIiLCJlbWFpbCI6InVjdjIwMjFAZW1haWwuY29tIn0sImlhdCI6MTY2ODgwODkzNX0.vi3y5HqOOZWx33EmnUrDqehG-eSlhv8d18nYqCEIM-E', '2022-11-18 17:02:15', 51),
(181, 'bd084ef0-38c1-47bd-8033-5aefa0860e6a', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjo5NjkyODAyNTUsIm5vbWJyZSI6ImJyYWRjYXIiLCJlbWFpbCI6InVjdjIwMjFAZW1haWwuY29tIn0sImlhdCI6MTY2ODgwOTAyN30.rmeKht1sZSn__Tt30UfCl3Yie3XRUKhW0sYC7k2JmYI', '2022-11-18 17:03:47', 50),
(182, '96158970-a0b3-41bd-82ad-366cd4880774', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjo5NjkyODAyNTUsIm5vbWJyZSI6ImJyYWRjYXIiLCJlbWFpbCI6InVjdjIwMjFAZW1haWwuY29tIn0sImlhdCI6MTY2ODgxMDk0MH0.v1_Eh81TAej2B3x46pNfuLsQzXNdtYMwciOUzQRpEmE', '2022-11-18 17:35:40', 54),
(183, '40a2aca9-fa75-4f53-852b-acce1ede3200', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjo5NjkyODAyNTUsIm5vbWJyZSI6ImJyYWRjYXIiLCJlbWFpbCI6InVjdjIwMjFAZW1haWwuY29tIn0sImlhdCI6MTY2ODgxMjAzM30.DKCVA9dZ6T01ada1XSsEeaP-kSMTRFvHCWZ71flxnG0', '2022-11-18 17:53:53', 50),
(184, 'ec1592c5-5539-4d13-9cea-8fc44c7dea84', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjo5NjkyODAyNTUsIm5vbWJyZSI6ImJyYWRjYXIiLCJlbWFpbCI6InVjdjIwMjFAZW1haWwuY29tIn0sImlhdCI6MTY2ODgyNzY0NX0.JwHNuQje3k2RwijiWWstF5m_DIKcb3kPJeDryezqdC4', '2022-11-18 22:14:05', 53),
(185, 'ad92bc9d-6334-4ae5-bc03-011d637e0964', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjo5NjkyODAyNTUsIm5vbWJyZSI6ImJyYWRjYXIiLCJlbWFpbCI6InVjdjIwMjFAZW1haWwuY29tIn0sImlhdCI6MTY2ODgyNzcxMX0.ODhB524BjGsNvNkEUrvH6DuDSkx4XKgEYmnoVPBXp7U', '2022-11-18 22:15:11', 54),
(186, '9d9d1ba8-0fcd-43ef-8330-47323fa96b7a', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjo5NjkyODAyNTUsIm5vbWJyZSI6ImJyYWRjYXIiLCJlbWFpbCI6InVjdjIwMjFAZW1haWwuY29tIn0sImlhdCI6MTY2ODg3NzYzM30.R9bXnSxySWEaffCgDfABdRTRU1I1OQ5d3T_vtFPDL6M', '2022-11-19 12:07:13', 53),
(187, '3fd07bf3-862e-4c63-a4f0-ba076733a42f', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjo5NjkyODAyNTUsIm5vbWJyZSI6ImJyYWRjYXIiLCJlbWFpbCI6InVjdjIwMjFAZW1haWwuY29tIn0sImlhdCI6MTY2ODg3ODA4NH0.rGUHX5xqjt7OQsiBN3qaCtgCLPD25KisxsrqEGOFinE', '2022-11-19 12:14:44', 50),
(188, '9700d0d8-0580-4bcf-b66f-411320782dc2', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjo5NjkyODAyNTUsIm5vbWJyZSI6ImJyYWRjYXIiLCJlbWFpbCI6InVjdjIwMjFAZW1haWwuY29tIn0sImlhdCI6MTY2ODg4Mjk2Mn0.sBWGcYgZbXgQcvb3DbNJMTnJ_PM6NmeYOBAU-TeH7ew', '2022-11-19 13:36:02', 54),
(189, '77d9869d-a7d7-4873-add4-2b192ec98996', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjo5NjkyODAyNTUsIm5vbWJyZSI6ImJyYWRjYXIiLCJlbWFpbCI6InVjdjIwMjFAZW1haWwuY29tIn0sImlhdCI6MTY2ODk4MjE4M30.a-ISgaepMk3PUk4tC9uwe4A8JSzMr4B-sy0llLzD7_w', '2022-11-20 17:09:43', 54),
(190, '9a9ed2b4-3126-4354-8b2f-f5eaac13aa9b', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjo5NjkyODAyNTUsIm5vbWJyZSI6ImJyYWRjYXIiLCJlbWFpbCI6InVjdjIwMjFAZW1haWwuY29tIn0sImlhdCI6MTY2ODk4MjY1OX0.H8N-yO3xWTHhfkJTXLF7ILcGPtyqH16lVT6wUCDUYG4', '2022-11-20 17:17:39', 85),
(191, '395849db-a79a-444e-be33-2cf2c8a654ea', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjo5NjkyODAyNTUsIm5vbWJyZSI6ImJyYWRjYXIiLCJlbWFpbCI6InVjdjIwMjFAZW1haWwuY29tIn0sImlhdCI6MTY2OTAwNDE5M30.uj9ci6iZd8wBXPjS_u6qLylkzNfPEVYFgdfCgOf_F8o', '2022-11-20 23:16:33', 51),
(192, '46f1c6f5-a48d-4b98-8dc1-8bcbb14bb791', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjo5NjkyODAyNTUsIm5vbWJyZSI6ImJyYWRjYXIiLCJlbWFpbCI6InVjdjIwMjFAZW1haWwuY29tIn0sImlhdCI6MTY2OTAwNDI0NX0.ZIzLuOvgcD52Y0OBHVDzWo3caSRrM-rs3Rk3TBGV7iw', '2022-11-20 23:17:25', 51),
(193, '47fdae75-10f9-4694-9d5b-f8b0bfb3a126', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjo5NjkyODAyNTUsIm5vbWJyZSI6ImJyYWRjYXIiLCJlbWFpbCI6InVjdjIwMjFAZW1haWwuY29tIn0sImlhdCI6MTY2OTA0Mjg5NH0.08y392xXnyU1Wmnxn_2XdCYLHg-Q-hCSzVzaxHEmIYg', '2022-11-21 10:01:34', 51),
(194, 'ebeaf92c-0bae-4a79-bf65-3a7c877441a8', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjo5NjkyODAyNTUsIm5vbWJyZSI6ImJyYWRjYXIiLCJlbWFpbCI6InVjdjIwMjFAZW1haWwuY29tIn0sImlhdCI6MTY2OTA0MzM4MH0._QFLYGivaoQL2Ith7g988A-LtV1iGPbpPxgaUWAZ9Vg', '2022-11-21 10:09:40', 51),
(195, '49cac123-3b46-4b1f-b933-bd3428939aa0', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjo5NjkyODAyNTUsIm5vbWJyZSI6ImJyYWRjYXIiLCJlbWFpbCI6InVjdjIwMjFAZW1haWwuY29tIn0sImlhdCI6MTY2OTA0NDc4NH0.ahZ2wh7f7vUye62ag6wlQoUkhO4xPvly4dgjQJAg0ew', '2022-11-21 10:33:04', 51),
(196, 'e42b38f5-b8b3-4229-804c-a68f0bf9af19', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjo5NjkyODAyNTUsIm5vbWJyZSI6ImJyYWRjYXIiLCJlbWFpbCI6InVjdjIwMjFAZW1haWwuY29tIn0sImlhdCI6MTY2OTA0NTAwOX0.UOV1DuuGjAHydFBlT8FIbFjz1NSomq-BrHeTHs-xftM', '2022-11-21 10:36:49', 51),
(197, 'f3e0d758-a5ae-49c9-b220-c29321960e95', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjo5NjkyODAyNTUsIm5vbWJyZSI6ImJyYWRjYXIiLCJlbWFpbCI6InVjdjIwMjFAZW1haWwuY29tIn0sImlhdCI6MTY2OTA0NTE1NX0.usZGYtAu5746Hdtn8BicIwL3Q5m_Inx-v1tJxRNcfco', '2022-11-21 10:39:15', 51),
(198, 'db2bd0fc-c445-4ebd-bf15-3004210eb740', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjo5NjkyODAyNTUsIm5vbWJyZSI6ImJyYWRjYXIiLCJlbWFpbCI6InVjdjIwMjFAZW1haWwuY29tIn0sImlhdCI6MTY2OTA0NjA2Nn0.5SMUUAfnsw3gMiiq7t924T__tqKYQ6gkbg0g20K3AlI', '2022-11-21 10:54:27', 51),
(199, 'b0e38c9f-2e68-48fb-92b9-783bb3a75ffd', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjo5NjkyODAyNTUsIm5vbWJyZSI6ImJyYWRjYXIiLCJlbWFpbCI6InVjdjIwMjFAZW1haWwuY29tIn0sImlhdCI6MTY2OTA0NjQwNX0.WTby61cqoM8hfoDZl8yiMElL7SYTeBYJJOTeMBlGBWo', '2022-11-21 11:00:05', 51),
(200, '6edc7017-31db-4206-a557-95060d593183', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjo5NjkyODAyNTUsIm5vbWJyZSI6ImJyYWRjYXIiLCJlbWFpbCI6InVjdjIwMjFAZW1haWwuY29tIn0sImlhdCI6MTY2OTA0NzkyNH0.YY5SbymlVE08p4Z1Ol3aAPsudUoV_IHYQJvgwg7o7UY', '2022-11-21 11:25:24', 51),
(201, 'e4133281-30a0-4468-b5df-8d184286bfe5', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjo5NjkyODAyNTUsIm5vbWJyZSI6ImJyYWRjYXIiLCJlbWFpbCI6InVjdjIwMjFAZW1haWwuY29tIn0sImlhdCI6MTY2OTA0ODM3OH0.ljLsfRvhPDuQ11D5n8QLhl1Qj56YGNXmSv-00jTdQck', '2022-11-21 11:32:58', 51),
(202, 'f1f63fbc-4e26-4032-8bb7-0c1fdcb0400c', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjo5NjkyODAyNTUsIm5vbWJyZSI6ImJyYWRjYXIiLCJlbWFpbCI6InVjdjIwMjFAZW1haWwuY29tIn0sImlhdCI6MTY2OTA0OTMwNX0.bO5MD4xXs0wYrrmcNDxY0r4zifP3XqUylPU7gwl5xVw', '2022-11-21 11:48:25', 51),
(203, '67bd4243-5925-45fe-917f-6fe7fc3d1716', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjo5NjkyODAyNTUsIm5vbWJyZSI6ImJyYWRjYXIiLCJlbWFpbCI6InVjdjIwMjFAZW1haWwuY29tIn0sImlhdCI6MTY2OTA0OTUzOH0.WUNcepeX97EnuwKZqWBs2oh6BAnFTvFrznHcxusEyqA', '2022-11-21 11:52:18', 51),
(204, '8d232f43-d906-46d5-8428-3bf0c6838f55', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjo5NjkyODAyNTUsIm5vbWJyZSI6ImJyYWRjYXIiLCJlbWFpbCI6InVjdjIwMjFAZW1haWwuY29tIn0sImlhdCI6MTY2OTA0OTg5N30.WJ3WnMENKYNOj8RQnr_qVSOrHKHqDrcBQv1emfqm3P0', '2022-11-21 11:58:17', 50),
(205, '051ce433-f21d-4093-bf29-67d41e62dff0', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjo5NjkyODAyNTUsIm5vbWJyZSI6ImJyYWRjYXIiLCJlbWFpbCI6InVjdjIwMjFAZW1haWwuY29tIn0sImlhdCI6MTY2OTA1MTIzOX0.48yB8m-TWgeMGyJ20qCNnruzJLFVdjRFfXq_K-f5jTw', '2022-11-21 12:20:39', 71);
...
(51, 'P', 'canvaritech.gerente@gmail.com', '969280255', 'ANCAJIMA MAURIOLA Julio Sergio Adolfo', 978376949, 'canvaritech.gerente@gmail.com', 1, 'https://thumbs.dreamstime.com/b/icono-gris-de-perfil-usuario-s%C3%ADmbolo-empleado-avatar-web-y-dise%C3%B1o-ilustraci%C3%B3n-signo-aislado-en-fondo-blanco-191067342.jpg'),
...
(53, 'P', 'anamariacastillodelgado2@gmail.com', 'Universidad de ', 'Ana Maria Castillo Delgado', 947401880, 'anamariacastillodelgado2@gmail.com', 1, 'https://thumbs.dreamstime.com/b/icono-gris-de-perfil-usuario-s%C3%ADmbolo-empleado-avatar-web-y-dise%C3%B1o-ilustraci%C3%B3n-signo-aislado-en-fondo-blanco-191067342.jpg'),
...
(64, 'C', 'carlgarcia@gmail.com', 'univerlucia', 'Carlos Guevara Garcia', 985796307, 'carlgarcia@gmail.com', 0, 'http://res.cloudinary.com/canvarith/image/upload/v1665797551/Images/a8t1p7tmhltwixp4ryzh.jpg'),
...
(67, 'C', 'estefanyguer4@gmail.com', '741852963a', 'Carlos Arturo Guerrero Castillo', 985796307, 'estefanyguer4@gmail.com', 0, 'https://thumbs.dreamstime.com/b/icono-gris-de-perfil-usuario-s%C3%ADmbolo-empleado-avatar-web-y-dise%C3%B1o-ilustraci%C3%B3n-signo-aislado-en-fondo-blanco-191067342.jpg'),
...
(69, 'C', 'artu222000@gmail.com', '123456', 'Carlos Arturo Guerrero Garcia', 969280255, 'artu222000@gmail.com', 0, 'https://thumbs.dreamstime.com/b/icono-gris-de-perfil-usuario-s%C3%ADmbolo-empleado-avatar-web-y-dise%C3%B1o-ilustraci%C3%B3n-signo-aislado-en-fondo-blanco-191067342.jpg'),
...
(71, 'A', 'Admincanvaritch2@admin.com', '17072022devcanv', 'Ana Maria Castillo Delgado', 969280255, 'Admincanvaritch2@admin.com', 1, 'http://res.cloudinary.com/canvarith/image/upload/v1667852139/Images/k9usn2eisjd3vhkgfmuf.jpg'),
...
(77, 'P', 'sdfdfdsfsdfdsf@gmail.com', '147852369', 'sdfsdfdsfdsfdsf', 121354567, 'sdfdfdsfsdfdsf@gmail.com', 0, 'https://thumbs.dreamstime.com/b/icono-gris-de-perfil-usuario-s%C3%ADmbolo-empleado-avatar-web-y-dise%C3%B1o-ilustraci%C3%B3n-signo-aislado-en-fondo-blanco-191067342.jpg'),
(78, 'P', 'fgdhgfdhfghf@gmail.com', '12315465879878', 'gfhghdghfdhdfg', 454562115, 'fgdhgfdhfghf@gmail.com', 0, 'https://thumbs.dreamstime.com/b/icono-gris-de-perfil-usuario-s%C3%ADmbolo-empleado-avatar-web-y-dise%C3%B1o-ilustraci%C3%B3n-signo-aislado-en-fondo-blanco-191067342.jpg'),
...
(80, 'C', 'garger@gmail.com', '969280255', 'Garcia Gevara', 969280255, 'garger@gmail.com', 1, 'https://thumbs.dreamstime.com/b/icono-gris-de-perfil-usuario-s%C3%ADmbolo-empleado-avatar-web-y-dise%C3%B1o-ilustraci%C3%B3n-signo-aislado-en-fondo-blanco-191067342.jpg'),
(81, 'A', 'caguerrerog@gmail.com', '1234567', 'Carlos Arturo Guerrero Castillo', 985796307, 'caguerrerog@gmail.com', 0, 'http://res.cloudinary.com/canvarith/image/upload/v1668785133/Images/grdmqgpjuhbxelooiqfe.jpg'),
(82, 'P', 'anaguervhurt12@gmail.com', 'Univercidad Car', 'Ana Guevara Hurtado', 969280255, 'anaguervhurt12@gmail.com', 0, 'http://res.cloudinary.com/canvarith/image/upload/v1668785603/Images/f2hludelywbu4v9uuhw5.jpg'),
(83, 'C', 'analu12@gmail.com', '12345678945', 'Ana Lucia Garcia', 985796307, 'analu12@gmail.com', 0, 'http://res.cloudinary.com/canvarith/image/upload/v1668785980/Images/sgrmwttxhosczicndm5r.jpg'),
(84, 'A', 'analuciajimenez@gmail.com', '159456', 'Ana Lucia Jimenez Garcia', 985796307, 'analuciajimenez@gmail.com', 1, 'https://thumbs.dreamstime.com/b/icono-gris-de-perfil-usuario-s%C3%ADmbolo-empleado-avatar-web-y-dise%C3%B1o-ilustraci%C3%B3n-signo-aislado-en-fondo-blanco-191067342.jpg'),
(85, 'C', 'josefir@gmail.com', '123456789', 'Jose Fina Garcia', 969280255, 'josefir@gmail.com', 1, 'https://thumbs.dreamstime.com/b/icono-gris-de-perfil-usuario-s%C3%ADmbolo-empleado-avatar-web-y-dise%C3%B1o-ilustraci%C3%B3n-signo-aislado-en-fondo-blanco-191067342.jpg'),
(86, 'C', 'carligar@gmail.com', 'acv23456', 'carlita guercia', 969280255, 'carligar@gmail.com', 1, 'https://thumbs.dreamstime.com/b/icono-gris-de-perfil-usuario-s%C3%ADmbolo-empleado-avatar-web-y-dise%C3%B1o-ilustraci%C3%B3n-signo-aislado-en-fondo-blanco-191067342.jpg');
...
--
ALTER TABLE `asist_inscrip`
  MODIFY `id_asis_inscrip` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT de la tabla `ciclo_curso`
--
ALTER TABLE `ciclo_curso`
  MODIFY `id_ciclo_curso` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
...
--
ALTER TABLE `inscripcciones`
  MODIFY `id_inscrip` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;

--
-- AUTO_INCREMENT de la tabla `inscrip_point_sesion`
--
ALTER TABLE `inscrip_point_sesion`
  MODIFY `id_inscrip_p_sea` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;

--
-- AUTO_INCREMENT de la tabla `profesor`
--
ALTER TABLE `profesor`
  MODIFY `id_profesor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT de la tabla `puntosclass`
--
ALTER TABLE `puntosclass`
  MODIFY `id_tipo_puntos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;
...
--
ALTER TABLE `sing_log`
  MODIFY `id_sing_log` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=206;
...
--
ALTER TABLE `tipo_curso`
  MODIFY `id_tipocurso` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
