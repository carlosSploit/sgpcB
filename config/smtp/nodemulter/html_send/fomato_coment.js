...
<body style="background-color:#FFFFFF;">
    <div style="background-color:#FFFFFF;">
        <table align="center"
            ...
            style="background:#c098ac top center / cover repeat;width:100%;">
            <tbody>
                <tr>
                    <td>
                        <!--[if mso | IE]>
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td style="width:372px;">
                                                                                <img height="auto"
                                                                                    src="https://res.cloudinary.com/canvarith/image/upload/v1650517842/Images/logo_e1o8oq.png"
    ...
    <![endif]-->
                                                        ...
                                                        <td align="left"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="text-align: center;"><span
                                                                        style="font-size: 24px; font-family: Arial, sans-serif;"><strong>
                                                                            &nombre& </strong></span>
                                                                </p>
                                                            </div>
                                                        </td>
      ...
      <![endif]-->
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
            style="background: #846cc4;background-color: #846cc4;width:100%;">
            <tbody>
                <tr>
                    <td>
                        <!--[if mso | IE]>
                                                                            ...
                                                                            <table border="0" cellpadding="0"
                                                                                ...
                                                                                <tr>
                                                                                    <td
                                                                                        ...
                                                                                        <a href="https://www.facebook.com/SuperAdaGame"
                                                                                            target="_blank"
                                                                                            style="color: #0000EE;">
                                                                                            <img alt="facebook"
                                                                                                height="35"
                                                                        ...
                                                                        <td style="padding:4px;">
                                                                            <table border="0" cellpadding="0"
                                                                                ...
                                                                                <tr>
                                                                                    <td
                                                                                        style="font-size:0;height:35px;vertical-align:middle;width:35px;">
                                                                                        <a href="https://twitter.com/superada_game"
                                                                                            target="_blank"
                                                                                            style="color: #0000EE;">
                                                                                            <img alt="twitter"
                                                                                                height="35"
                                                                        ...
                                                                        <td style="padding:4px;">
                                                                            <table border="0" cellpadding="0"
                                                                                ...
                                                                                <tr>
                                                                                    <td
                                                                                        style="font-size:0;height:35px;vertical-align:middle;width:35px;">
                                                                                        <a href="https://www.instagram.com/superada_game"
                                                                                            target="_blank"
                                                                                            style="color: #0000EE;">
                                                                                            <img alt="instagram"
                                                                                                height="35"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="text-align: center;"><span
                                                                            style="font-family: Arial, sans-serif;"><strong><span
                                                                                    ...
                                                                                    &nbsp; +51
                                                                                    978 376 948</span></strong></span></p>
                                                                    <p style="text-align: center;"><span
                                                                            style="font-family: Arial, sans-serif;"><strong><span
