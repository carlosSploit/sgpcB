...
module.exports = class ETLcontroles {
  ...
  async Extrac () {
    const LoadFilte = fs.readFileSync(require.resolve('./data/classControl.csv'), { encoding: 'utf8' })
  ...
  // INSERT INTO `classcontrol`(`id_classControl`, `abrebClassControl`, `nombreClassControl`, `estade`) VALUES
