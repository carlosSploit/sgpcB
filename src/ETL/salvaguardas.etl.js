...
// ######################### DbclientAnali ###################################
module.exports = class ETLAmenasas {
  async Load () {
  }

  async Extrac () {
    const LoadFilte = fs.readFileSync(require.resolve('./data/salvaguardas.csv'), { encoding: 'utf8' })
  ...
  // INSERT INTO `salvaguardas`(`id_salvaguardas`, `id_tipoSalva`, `abreb`, `descripc`, `estade`) VALUES
