...
module.exports = class ETescalImpac {
  ...
  async Extrac () {
    const LoadFilte = fs.readFileSync(require.resolve('./data/escalImpatResid.csv'), { encoding: 'utf8' })
  ...
  // INSERT INTO `escalaimpactoresidual`(`id_escalImpaResid`, `nombreEscalImpaResid`, `codigEscalImpaResid`, `valorEscalImpaResid`, `rangValEscalImpaResid`, `estade`) VALUES
