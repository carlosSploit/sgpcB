...
module.exports = class ETescalDegrad {
  ...
  async Extrac () {
    const LoadFilte = fs.readFileSync(require.resolve('./data/escalDegrResid.csv'), { encoding: 'utf8' })
  ...
  // INSERT INTO `escaladegradresidual`(`id_escalDegradResid`, `nombreEscalDegradResid`, `codigEscalDegradResid`, `valorEscalDegradResid`, `rangValEscalDegradResid`, `estade`) VALUES
