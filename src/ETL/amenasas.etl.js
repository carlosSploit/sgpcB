...
module.exports = class ETLAmenasas {
  ...
  async Extrac () {
    const LoadFilte = fs.readFileSync(require.resolve('./data/amenasas.csv'), { encoding: 'utf8' })
  ...
  // INSERT INTO `amenazas`(`id_amenaza`, `nombreAmena`, `abreb`, `descripc`, `id_tipoActiv`, `estade`) VALUES
