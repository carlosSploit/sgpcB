...
// ######################### DbclientAnali ###################################
module.exports = class ETescalImpac {
  async Load () {
  }

  async Extrac () {
    const LoadFilte = fs.readFileSync(require.resolve('./data/escalFrecuResid.csv'), { encoding: 'utf8' })
  ...
  // INSERT INTO `escalafrecuenresidual`(`id_escalFrecuenResid`, `nombreEscalFrecuenResid`, `codigEscalFrecuenResid`, `valorEscalFrecuenResid`, `rangValEscalFrecuenResid`, `estade`) VALUES
