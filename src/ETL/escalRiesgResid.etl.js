...
module.exports = class ETescalImpac {
  ...
  async Extrac () {
    const LoadFilte = fs.readFileSync(require.resolve('./data/escalRiesResid.csv'), { encoding: 'utf8' })
  ...
  // INSERT INTO `escalariesgoresidual`(`id_escalRiesgResid`, `nombreEscalRiesgResid`, `codigEscalRiesgResid`, `valorEscalRiesgResid`, `rangValEscalRiesgResid`, `estade`) VALUES
